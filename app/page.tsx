...
export default function Chat() {
  ...
  const HEADER_HEIGHT_PX = 88; // leave as-is visually
  const FOOTER_HEIGHT_PX = 150; // leave as-is visually
      ...
      <main className="w-full dark:bg-black h-screen relative">
        ...
        >
          <div className="relative overflow-visible h-full">
            <ChatHeader>
              <ChatHeaderBlock />
              {/* CENTER block: updated for larger logo, title + subtitle */}
              <ChatHeaderBlock className="justify-center items-center header-center">
                <div className="header-inner flex items-center justify-center w-full">
                  <div className="header-top flex items-center gap-3">
                    <Avatar className="size-10 header-avatar ring-1" >
                    ...
                    <div className="header-title-wrap flex flex-col text-left">
                      <div className="chat-title text-base font-semibold">
                        Chat with <span className="brand text-[16px] font-bold">{AI_NAME}</span>
                      </div>
                      <div className="chat-subtitle text-xs text-muted-foreground mt-1">
        ...
        {/* Scrollable chat container.
            Using inline style paddingTop/paddingBottom to ensure nothing scrolls under header/footer.
            This avoids relying on global CSS changes. */}
        <div
        ...
        {/* Footer / input area - kept fixed and unchanged (only markup spacing preserved) */}
        <div
